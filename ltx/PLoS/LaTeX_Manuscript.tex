...
\begin{figure}
   	...
   	\end{center}
   	\caption{{\bf Example of a field decomposition.} An example of a continuous one-dimensional field decomposed by a finite number of basis functions scaled by the state vector.} 
...
\begin{figure}
  ...
  \caption{{\bf Distribution of the parameter estimates over 100

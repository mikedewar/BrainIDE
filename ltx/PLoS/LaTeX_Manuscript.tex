...
\begin{figure}
   	...
   	\end{center}
   	\caption{{\bf Mexican-hat connectivity kernel, $w(\mathbf{r},\mathbf{r'})$}. The function $w(\cdot)$ is rotationally symmetric (isotropic) about zero, hence a cross-section captures the important aspect of the connectivity kernel's shape. The kernel decays asymptotically to zero.}
 	\label{fig:2d_kernel}
   \end{figure}

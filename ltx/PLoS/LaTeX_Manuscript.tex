...
\begin{equation}
    ...
    \begin{split}
	 ...
	 \end{split}
\end{equation}
An analytic derivation of the inner product of \emph{n}-dimensional Gaussians is provided in the Supporting Information, S1. Equation~\ref{eq:ReducedForm} can be simplified by exploiting the symmetry (isotropy) of the connectivity kernel where
\begin{equation}
...
Dean Freestone would like to thank Dr. Mark van Rossum for hosting him whilst visiting the University of Edinburgh where this work was undertaken. Authors would also like to thank Andrew Hills for useful discussions and help with some code and the generation of figures.

...
\begin{document}
    ...
    \begin{enumerate}
		...
		\emph{These results show that the system may not be identifiable in non-ideal, practical situations. Nevertheless, the net shape of the estimated kernels will be in accordance to actual data.}
...
\begin{enumerate}
	...
	\emph{\parham{It doesn't introduce additional connectivity kernel e.g the second order model is in a form of \begin{equation}
...
\dean{\emph{The author do not have much to add to this comment. We feel that adding the disturbance to the firing rate is appropriate for this model, which is what we have done. By the central limit theorem, we expect the disturbance to be Gaussian and due to the structural organization of the cortex, we expect the disturance to be spatially colored. In future work we plan to add to the framework and show how the disturbance properties can also be estimated from data.}}

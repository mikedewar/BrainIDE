...
The stimulation for the current source consisted of a 40~Hz sine wave with a duration of 1~s. The recording from the central electrode was used construct the sensor kernel. To extract the amplitude the signal the data was first band-pass filtered with a centre frequency of 40~Hz. The the envelope of the signal was found by
\begin{equation}

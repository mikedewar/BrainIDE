...
\begin{equation}
	...
	\, d\mathbf{r}'dt'.
\end{equation}
\dean{(reviewer 2, comment 3:) To arrive at the standard integro-differential equation form of the model, we use the fact that the synaptic response kernel is a Green's function of a linear differential equation defined by the operator $\textrm{D}=d/dt + \zeta$. A Green's function satisfies
\begin{equation}

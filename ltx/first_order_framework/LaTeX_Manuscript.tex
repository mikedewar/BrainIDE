...
Parts a), b) and c) of Figure~\ref{fig:Figure8} show results from the Mexican hat kernel parameters were varied. For Part a), the kernel estimates are not in good accordance with the true kernel, as the true kernel falls outside of the confidence intervals in some areas. \dean{This is because???} 

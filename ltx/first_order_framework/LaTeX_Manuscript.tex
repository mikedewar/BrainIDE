...
\end{equation}
\parham{(reviewer 2, comment 7:) The positive constant $\alpha$ that determines the spread of the sigma points around $\mathbf{\bar x}$ is typically set arbitrary small (e.g., $10^{-3}$) to minimise higher-order effects \citep{Haykin2001}, and  $\kappa$ is an additional scaling parameter which was set to $3-n_x$ in accordance to \citet{Julier2002a}.}

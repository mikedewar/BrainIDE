...
\begin{align}
	R_{y_{t},y_{t+1}}(\boldsymbol{\tau}) &= \mathbf{E}\left[\mathcal{F}^{-1} \left\{e^{i\boldsymbol{\nu}^{\top}\boldsymbol{\tau}} M(\boldsymbol{\nu}) V(\boldsymbol{\nu}) \ast \left(\xi M(\boldsymbol{\nu})V(\boldsymbol{\nu}) + T_s M(\boldsymbol{\nu}) W(\boldsymbol{\nu}) \varsigma V(\boldsymbol{\nu}) \right) \right\} \right] \\
	...
	&= (R_{y_t,y_t} - \delta(\boldsymbol{\tau})\sigma_{\varepsilon}^2) \ast \mathbf{E}\left[\left(\xi  + T_s \varsigma w(\mathbf{r})\right) \right]
\end{align}
% 
% \begin{align}
...
\begin{align}
	...
	&= \mathbf{E}\left[m(\mathbf{r}_n+\boldsymbol{\tau})\ast v(\mathbf{r}) \times m(\mathbf{r}_n)\ast v(\mathbf{r})\right] + \delta(\boldsymbol{\tau})\sigma_{\varepsilon}^2 \\
	&= \mathbf{E}\left[m(\mathbf{r}_n+\boldsymbol{\tau}) \ast m(\mathbf{r}_n) \ast v^2(\mathbf{r})\right] + \delta(\boldsymbol{\tau})\sigma_{\varepsilon}^2
\end{align}
To show how we get this result, we first define
\begin{align}
	K(\boldsymbol{\nu}) &= \mathcal{F}\left\{m(\mathbf{r}_n+\boldsymbol{\tau}) \ast v(\mathbf{r}) \times m(\mathbf{r}_n) \ast v(\mathbf{r})\right\} \\
	&= \exp(i\boldsymbol{\nu}^{\top}\boldsymbol{\tau})M(\boldsymbol{\nu})V(\boldsymbol{\nu}) \ast M(\boldsymbol{\nu})V(\boldsymbol{\nu}) \\
	&= \exp(i\boldsymbol{\nu}^{\top}\boldsymbol{\tau})M(\boldsymbol{\nu})V(\boldsymbol{\nu}) \ast M(\boldsymbol{\nu})V(\boldsymbol{\nu}) \\
	&= \exp(i\boldsymbol{\nu}^{\top}\boldsymbol{\tau})M(\boldsymbol{\nu})M(\boldsymbol{\nu})V(\boldsymbol{\nu}) \ast V(\boldsymbol{\nu}).
\end{align}
...
\begin{align}
	k(\mathbf{r}) = m(\mathbf{r}_n+\boldsymbol{\tau}) \ast m(\mathbf{r}_n) \ast v^2(\mathbf{r}).
\end{align}

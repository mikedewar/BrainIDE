...
Parts a), b) and c) of Figure~\ref{fig:Figure8} show results from the Mexican hat kernel parameters were varied. In all cases the actual kernel fell within the confidence interval of the estimated kernel. The mean kernel estimate for Part b) shows very good accordance with the actual kernel. In the other Parts a) and c) there is an over estimate and an underestimate of the kernel, respectively. These bias are a result 

...
\label{App:Time Discretization} To form the integro-difference equation neural field model, a time discretisation must be performed. To do this, we used a one-step Euler method, where equation~7 of the main text can be approximated by 
\begin{align}

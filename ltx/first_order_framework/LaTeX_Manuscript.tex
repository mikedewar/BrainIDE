...
\section{Conclusion}
This paper has made a contribution to bridging the gap between experimental and theoretical neuroscience by developing a systematic methodology. \dean{Please add to this.} Novel aspects of this work include a model reduction procedure such that a finite-dimension state-space model constructed... 

...
To implement the algorithm in a real-time scenario the we would assume that the parameters are stationary over a time period (window) where the estimation is performed. The parameter of the previous window can be used to initialize parameters of the next window.  }

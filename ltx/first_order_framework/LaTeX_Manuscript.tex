...
\begin{align}
	...
	&= (R_{y_t,y_t}(\boldsymbol{\tau}) - \delta(\boldsymbol{\tau})\sigma_{\varepsilon}^2) \ast \mathbf{E}\left[\left(\xi  + T_s \varsigma w(\mathbf{r})\right) \right]
\end{align}
% 
% \begin{align}
...
\begin{align}
	K(\boldsymbol{\nu}) &= \mathcal{F}\left\{m(\mathbf{r}+\boldsymbol{\tau}) \ast v(\mathbf{r}) \times m(\mathbf{r}_n) \ast v(\mathbf{r})\right\} \\
	&= \exp(i\boldsymbol{\nu}^{\top}\boldsymbol{\tau})M(\boldsymbol{\nu})V(\boldsymbol{\nu}) \ast M(\boldsymbol{\nu})V(\boldsymbol{\nu}) \\
	&= \exp(i\boldsymbol{\nu}^{\top}\boldsymbol{\tau})M(\boldsymbol{\nu})V(\boldsymbol{\nu}) \ast M(\boldsymbol{\nu})V(\boldsymbol{\nu}) \\
	&= \exp(i\boldsymbol{\nu}^{\top}\boldsymbol{\tau})M(\boldsymbol{\nu})M(\boldsymbol{\nu})V(\boldsymbol{\nu}) \ast V(\boldsymbol{\nu}).
\end{align}
...
\begin{align}
	k(\mathbf{r}) = m(\mathbf{r}+\boldsymbol{\tau}) \ast m(\mathbf{r}) \ast v^2(\mathbf{r}).
\end{align}

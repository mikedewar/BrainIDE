...
\end{center}
\caption{{\bf RMSE of the kernel estimates}. RMSE of the kernel for different values of $\sigma^2_y$. Mean kernel estimates are obtained over 50 realisations in each case.}
\label{fig:Figure12}
\end{figure*}
\section*{Tables}

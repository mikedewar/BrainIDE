...
Even though the continuous system is stable, there is no guarantee that the discrete system is stable when using Euler's method. Therefore, it is necessary to demonstrate the stability of the discretized IDE. To do this, the model is written as the series
\begin{align}

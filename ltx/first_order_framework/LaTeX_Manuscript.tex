...
To study the robustness of the estimation algorithm, the performance was studied for various connectivity kernel parameters. The reconstructed connectivity kernels from the estimated parameters are shown in Figure~\ref{fig:Figure8}. By changing the weights of the connectivity kernel we are effectively changing gain of the system and the range of the field amplitudes. Since the sigmoidal nonlinearity is remaining static, we are changing the operating region on the sigmoid. Therefore, we expect our estimation accuracy to vary. 

Losing higher frequency peaks
Losing higher frequency troughs

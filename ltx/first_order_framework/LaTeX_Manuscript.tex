...
Evaluating the middle term for the case where the field is in the linear region of the nonlinearity gives
\begin{align}
	...
	&= T_s\varsigma\mathbf{E}\left[ \bar{y}_t\left( \mathbf{r}_n + \boldsymbol{\tau} \right) \int_{\Omega}{ w\left(\mathbf{r}_n,\mathbf{r}'\right) y_t\left(\mathbf{r}'\right)\, d\mathbf{r}'}\right] \\
	&= ???? T_s\varsigma \int_{\Omega}{ w\left(\mathbf{r}_n,\mathbf{r}'\right) \mathbf{E}\left[ \bar{y}_t\left( \mathbf{r}_n + \boldsymbol{\tau} \right)\bar{y}_t\left( \mathbf{r}' \right)\right]\, d\mathbf{r}'},	
\end{align}
...
\begin{align}
	...
	&= T_s a_1 a_2 \int_{\Omega}{ m\left( \mathbf{r}_n - \mathbf{r}'\right) \mathbf{E}\left[ v_t\left( \mathbf{r}\right) \right] d\mathbf{r}'} \\
	&= T_s a_1 a_2 \int_{\Omega}{ m\left( \mathbf{r}_n - \mathbf{r}'\right) d\mathbf{r}'} \\
	&= T_s a_1 a_2^2 ,
\end{align}
...
\end{equation}
The right hand side of equation~\ref{eq:support_estimator} will have the structure of the connectivity kernel. My intuition tells me that we should be able to simplify the RHS to
\begin{equation}
	T_s\varsigma \mathbf{E}\left[ \bar{y}_t\left( \mathbf{r}_n + \boldsymbol{\tau} \right) \int_{\Omega}{ w\left(\mathbf{r}_n,\mathbf{r}'\right) \bar{y}_t\left( \mathbf{r}' \right)\, d\mathbf{r}'}\right] = T_s \varsigma \sigma_d \int_{\Omega}{ w\left(\mathbf{r}_n,\mathbf{r}'\right) \int_{\Omega}{ m(\mathbf{r}'-\mathbf{r}'') \gamma(\mathbf{r}'-\mathbf{r}'') d\mathbf{r}''}d\mathbf{r}'}.
\end{equation}
Following this, I also think that
\begin{equation}
	R_{\bar{y}_{t},\bar{y}_{t} } (\boldsymbol{\tau}) = \sigma_d \int_{\Omega}{ m(\mathbf{r}_n-\mathbf{r}') \gamma(\mathbf{r}-\mathbf{r}') d\mathbf{r}'}.
\end{equation}
This would mean that
\begin{equation}
	R_{y_{t},y_{t+1}}(\boldsymbol{\tau}) - \xi \sigma_d \int_{\Omega}{ m(\mathbf{r}_n-\mathbf{r}') \gamma(\mathbf{r}-\mathbf{r}')d\mathbf{r}'} = T_s \varsigma \sigma_d \int_{\Omega}{ w\left(\mathbf{r}_n,\mathbf{r}'\right) \int_{\Omega}{ m(\mathbf{r}'-\mathbf{r}'') \gamma(\mathbf{r}'-\mathbf{r}'') d\mathbf{r}''} d\mathbf{r}'},
\end{equation}
which is nice.

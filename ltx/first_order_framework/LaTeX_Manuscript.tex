...
\begin{align}
	...
	&= \mathbf{E}\left[m(\mathbf{r} + \boldsymbol{\tau}) \ast v(\mathbf{r}) \times m(\mathbf{r}) \ast v(\mathbf{r}) \ast \left( \xi \delta_D(\mathbf{r}) + T_s \varsigma w(\mathbf{r}) \right)\right] \\
...
Rearrange to get
\begin{equation}
	R_{y_{t},y_{t}}(\boldsymbol{\tau}) - \delta_K(\boldsymbol{\tau})\sigma_{\varepsilon}^2 = \mathbf{E}\left[m(\mathbf{r} + \boldsymbol{\tau}) \ast v(\mathbf{r}) \times m(\mathbf{r}) \ast v(\mathbf{r})\right].
\end{equation}

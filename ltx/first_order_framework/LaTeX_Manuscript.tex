...
\begin{equation}
	\mathbf{C}_{ij} = \int_{\Omega}m(\mathbf{r}_i - \mathbf{r}')\boldsymbol{\phi}_j(\mathbf{r}') \, d\mathbf{r}'.
\end{equation}
% \begin{equation}
% 	\mathbf{C} = \left[
% 	\begin{array}{{ccc}} 
...
\end{equation*}
\end{small}
Following this, the LS parameter estimates \ken{some reference for this result}, $ \hat{\mathcal{W}}$, are
\begin{equation}

...
{\bf Figure 12. RMSE of the kernel estimates}. RMSE of the kernel for different values of sensor width, $\sigma_m$, distance between adjacent sensors is $\Delta_y=1.5$. Mean kernel estimates are obtained over 50 realisations in each case.
\clearpage
\newpage
\begin{figure*}[!ht]
\begin{center}

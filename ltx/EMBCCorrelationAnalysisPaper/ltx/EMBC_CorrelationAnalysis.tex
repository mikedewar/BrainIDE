...
\begin{align}
	R_{y_{t+1}y_t}(\boldsymbol{\tau}) &= \int_{\Omega}\int_{\Omega} m(\mathbf{r}-\mathbf{r}')\left(\xi v_t(\mathbf{r}') + g_t(\mathbf{r}')\right. \nonumber \\
...
\begin{align}
	...
	\mathbf{E}\left[\int_{\Omega}\int_{\Omega} m(\mathbf{r}-\mathbf{r}') e_t(\mathbf{r}') d\mathbf{r}'y_t(\mathbf{r}+\boldsymbol{\tau}) d\mathbf{r}\right] = 0,
\end{align}
giving
\begin{align}
	R_{y_{t+1}y_t}(\boldsymbol{\tau}) &= \xi R_{y_ty_t}(\boldsymbol{\tau}) \nonumber \\
	&+ \int_{\Omega}\int_{\Omega} m(\mathbf{r}-\mathbf{r}') g_t(\mathbf{r}') d\mathbf{r}' y_t(\mathbf{r}+\boldsymbol{\tau}) d\mathbf{r}.
\end{align}
...
\begin{figure}[t!]
	...
	\caption{a) Removing the kernel from the spectrum of the estimate. b) Kernel left overs. c) Cross section of b.}
\end{figure}

...
\end{equation}
\begin{todo}
	{Is this equation correct? Is it a convolution in time?}
\end{todo}
...
\end{equation}
\begin{todo}
	{Do we really need this representation with $\bar t$. It makes convolution look wrong.}
\end{todo}
...
\end{equation}
\begin{todo}
	{Parham ... how are you writing this?}
...
To solve the convolution integral in \ref{Discrete Time Model1} we define the spatial aspect of the model on a regular square $i,j$ grid of neural masses, where the spatial step size $\Delta \mathbf{r}_i = \Delta \mathbf{r}_j = \Delta $ giving

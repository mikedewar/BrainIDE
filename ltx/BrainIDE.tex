...
\end{equation}
\begin{todo}
	{Do we really need this representation with $\bar t$. It makes convolution look wrong. DF: Don't need since we dont include delays. The motivation was to be general at the beginning, and for everyone to understand how the model is used elsewhere.}
\end{todo}
...
\begin{eqnarray}\label{Connectivity Kernel}
	w\left(r,r'\right) &=& \theta^T \psi\left(r,r'\right) \\
	\psi\left(r,r'\right) &=&\exp{\left(-\frac{1}{2}(r'-r)^T\Sigma_w (r'-r)\right)}
\end{eqnarray}
where
\begin{equation}
...
\end{equation}
\begin{todo}
	{Parham ... how are you writing this? DF: I have tried to make it better, but Parham can you check.}
...
\begin{equation}
	m\left(|r-r'|\right) = \exp{\left(-\frac{1}{2}(r'-r)^T\Sigma_m (r'-r)\right)}.
\end{equation}

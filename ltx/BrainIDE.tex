...
\begin{equation}\label{StartForDiscretization}
\tau\frac{dv\left( r,t \right)}{dt} = -v\left( r,t \right) + \int_\Omega  {w\left( r,r' \right)f\left( {v\left( r',t \right)} \right)dr'}  + e\left( r,t \right).
\end{equation}

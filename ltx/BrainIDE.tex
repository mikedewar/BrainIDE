...
v\left( {r,t} \right) = \int_{ - \infty }^t {h\left( {t - t'} \right)g\left( {r,t'} \right)dt'} + de\left( {r,t} \right).
\end{equation}
...
v\left(r,t\right) = \int\limits_{-\infty}^t\int\limits_\Omega  h\left(t - t'\right)w\left(r,r'\right)f\left( v\left( r',\bar t \right)\right)dr' dt'+de\left(r,t\right)
\end{equation}
...
\frac{dv\left( {r,t} \right)}{dt} + \alpha v\left( r,t \right) = \int_\Omega  {w\left( r,r' \right)f\left( {v\left( r',\bar t \right)} \right)dr'}  +de\left( r,t \right).
\end{equation}
...
\end{equation}
The spatial derivative of the Weiner process can be calculated since it is smooth in space (colored) although it is temporally white. 

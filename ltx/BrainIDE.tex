...
{\phi ^T}\left( r \right){x_{t + 1}} = {\theta ^T}\int_\Omega  {\psi \left( {r - r'} \right){\phi ^T}\left( {r'}\right)dr'} \rho \left( {{x_t}} \right) - \alpha {\phi ^T}\left( r \right){x_t} + \varepsilon \left( {r,t} \right)
\end{equation}
Now we define

...
\begin{align}
	...
	&= T_s \varsigma \mathbf{E}\left[ \hat{y}\left(\mathbf{r}+\boldsymbol{\tau}\right)  \int_{\Omega}\hat{y}\left(\mathbf{r}\right) w\left(\mathbf{r}'-\mathbf{r}\right) d\mathbf{r} \right] \\
	&= T_s \varsigma \mathbf{E}\left[  \int_{\Omega}\hat{y}\left(\mathbf{r}+\boldsymbol{\tau}\right)\hat{y}\left(\mathbf{r}\right) w\left(\mathbf{r}'-\mathbf{r}\right) d\mathbf{r} \right] \\
	&= T_s \varsigma   \int_{\Omega}\mathbf{E}\left[\hat{y}\left(\mathbf{r}+\boldsymbol{\tau}\right)\hat{y}\left(\mathbf{r}\right) \right] w\left(\mathbf{r}'-\mathbf{r}\right) d\mathbf{r}
\end{align}

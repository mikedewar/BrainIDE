...
\end{align}
By fitting a Gaussian to $m\star m \star \gamma$ and assuming the sensor kernel is Gaussian with width, $\sigma^2_m$ is known, the support of the disturbance covariance function, $\sigma^2_d$ can be obtained by
\begin{equation}

...
Consider first the maximisation of $\mathcal{Q}$-function with respect to $\boldsymbol\theta$, we can write
...
\end{equation}
The second derivative is negative definite at this stationary point, and hence it is a global maximizer of $\mathcal{Q}$-function. In order to maximise $\mathcal{Q}$-function with respect to $\xi$ we can write
...
\end{equation}
setting \eqref{eq:Qpartialxi} to zero and solving for $\xi$
\begin{equation}

...
\end{center}
\caption{{\bf Cross-section of disturbance covariance support estimation}. The true and the estimated width are shown by solid and dashed lines respectively.}

...
$\Xi_3, \Xi_5$&$O(n_x^3)+O(Tn_x^2)+O(Tn_xn_{\theta})$&$O(Tn_x^3)+O(Tn_x^2n_r)+O(Tn_xn_{\theta}n_r^2)$ \\
$\Xi_4$&$O(n_x^3)+O(Tn_x^2n_{\theta})+O(Tn_xn_{\theta}^2)$&$O(Tn_x^4n_{\theta})+O(Tn_x^3n_{\theta}^2)+O(Tn_x^3n_{\theta}n_r^2)$\\
$\hat{\boldsymbol\theta} $&$O(n_{\theta}^3)$&-\\
$\hat{\xi}$&$O(n_x^3+n_{\theta}^3)$&-\\
 $\hat{\sigma}_{\epsilon}^2$&$O(Tn_x^2n_y)+O(Tn_xn_y^2)$&-\\
$\hat{\sigma}_{d}^2$&$O(n_x^3)+O(n_{\theta}^2)$&-\\
\hline \hline
\end{tabular}}

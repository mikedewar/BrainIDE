...
$\Xi_3, \Xi_5$&$O(n_x^3)+O(Tn_x^2)+O(Tn_xn_{\theta})$&$O(Tn_x^3)+O(Tn_x^2n_r)+O(Tn_xn_{\theta}n_r)$ \\
$\Xi_4$&$O(n_x^3)+O(Tn_x^2n_{\theta})+O(Tn_xn_{\theta}^2)$&$O(Tn_x^4n_{\theta})+O(Tn_x^3n_{\theta}^2)+O(Tn_xn_{\theta}n_r)$\\

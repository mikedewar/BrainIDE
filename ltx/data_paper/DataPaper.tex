...
Here we describe the problem of estimating non-linear state-space neural field model using the expectation-maximisation (EM) technique. The resulting process is an iterative algorithm that converges on the maximum-likelihood estimates of the parameters.
\subsection{E-Step}

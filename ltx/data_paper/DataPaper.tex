...
\begin{eqnarray}
 \frac{\partial \mathcal Q}{\partial \sigma_d^2}&=& -(T-1)n_x\frac{1}{\sigma_d^2}+\frac{1}{\sigma_d^4}\mathrm{tr}\left\lbrace \Xi_0 \tilde{\boldsymbol\Sigma}_d^{-1}\right\rbrace-\frac{2\xi}{\sigma_d^4} \mathrm{tr}\left\lbrace \Xi_1 \tilde{\boldsymbol\Sigma}_e^{-1}\right\rbrace -2\frac{1}{\sigma_d^4}\Xi_2\boldsymbol\theta \nonumber \\
...
\end{eqnarray}
It can be also shown that the resulting solution is a maximum.

...
\begin{align}
\boldsymbol\Xi_{3}&\approx\sum_{t=0}^{T-1}\left[ \mathbf{\hat x}_{t+1}^\top\tilde{\boldsymbol\Sigma}_e^{-1}q(\mathbf{\hat x}_t^b)+\int_\Omega\boldsymbol \phi^\top(\mathbf r') \mathbf M_{t+1}^b \tilde{\boldsymbol\Sigma}_e^{-1} \boldsymbol{\Psi}(\mathbf{r}') f'(\boldsymbol \phi^\top(\mathbf r')\mathbf {\hat x}_t^b) d\mathbf{r}'\right] \\	
...
$\Xi_3, \Xi_5$&$O(Tn_x^2n_{\theta})$&$O(Tn_x^2n_r^2)+O(Tn_xn_{\theta}n_r^2)$ \\
$\Xi_4$&$O(Tn_x^2n_{\theta})+O(Tn_xn_{\theta}^2)$&$O(Tn_x^4n_{\theta}n_r^2)+O(Tn_x^3n_{\theta}^2n_r^2)$\\

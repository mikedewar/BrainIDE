...
\end{figure}
  \begin{figure}\label{fig:MRMSE}
   	\begin{center}
   		\includegraphics[width=0.5\textwidth]{./Graph/MRMSE.pdf} 
   	\end{center}
   	\caption{The mean of RMSE over time.} 
   \end{figure}

...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\documentclass[twocolumn,10pt,a4paper]{article}		%<-use this for checking equation length
...
\begin{figure}[th]\label{fig:experimental design}
   	\begin{center}
   		\subfigure[][]{\includegraphics[width=0.3\textwidth]{./Graph/ExperimentFigureEEGPy.pdf}} \\
   		\subfigure[][]{\includegraphics[width=0.3\textwidth]{./Graph/ExperimentFigurePSDPy.pdf}} \\
   	\end{center}
...
\end{figure}
\begin{figure}[th]
\subfigure[]{\includegraphics[scale=1]{./Graph/ZetaConvergence.pdf}}
\subfigure[][]{\includegraphics[scale=1]{./Graph/theta0Convergence.pdf}}\\
\subfigure[][]{\includegraphics[scale=1]{./Graph/theta1Convergence.pdf}}
\subfigure[][]{\includegraphics[scale=1]{./Graph/theta2Convergence.pdf}}
...
\end{figure*}
Following this, the distance between basis function, $\Delta_{\phi}$, was set to $2.5$ and the basis function width, $\sigma_{\phi}^2$, was set to 2.5, 2.63 mm full width at half maximum. \mike{Analysis said 0.44 from Parham's derivation, but 2.5 still overlaps and allows more high frequency details to be represented.}
...
\begin{figure*}[!th]
\centering 
\subfigure[][]{\includegraphics[scale=0.9]{./Graph/TrueField90.pdf}}
\subfigure[][]{\includegraphics[scale=0.9]{./Graph/EstimatedField90.pdf}}
\subfigure[][]{\includegraphics[scale=0.9]{./Graph/EstimationError90.pdf}}\\

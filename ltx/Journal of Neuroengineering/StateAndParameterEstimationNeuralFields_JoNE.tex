...
\begin{tabular}{c|c|c}
	...
	$\sigma_{\psi_{1}}, \sigma_{\psi_{2}}, \sigma_{\psi_{3}}$ & 1.8, 2.4, 6 & inner, middle and outer widths\\
	$\sigma_{m},\Delta_{y}$&0.9, 1.5&mm\\
	$\Sigma_{\epsilon}$ &$0.1 \times I_{N} $& observation noise covariance \\
	$\sigma_{\gamma}$&1.3&mm\\
	$\Delta$ & 0.5 & mm space step \\
	$T_s$ & 1 & ms time step \\ 
	\hline\hline
\end{tabular}

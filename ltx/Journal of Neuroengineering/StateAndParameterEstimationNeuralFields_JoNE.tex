...
\end{figure}
\begin{figure}[th]
\subfigure[]{\includegraphics[scale=0.7]{./Graph/ZetaConvergence.pdf}}
\subfigure[][]{\includegraphics[scale=0.7]{./Graph/theta0Convergence.pdf}}\\
\subfigure[][]{\includegraphics[scale=0.7]{./Graph/theta1Convergence.pdf}}
\subfigure[][]{\includegraphics[scale=0.7]{./Graph/theta2Convergence.pdf}}

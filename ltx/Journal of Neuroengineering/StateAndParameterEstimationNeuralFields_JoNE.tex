...
The width parameter of the Gaussian basis functions can also be inferred using spectral considerations~\cite{Sanner1992,Scerri2009}. To demonstrate this, we begin with the two-dimensional Gaussian basis function defined as
\begin{equation}
...
Given the basis function separation, the basis function width was set to $\sigma_{\phi}^2=2.5$. This facilitated a smooth representation of the field by the basis function decomposition given the basis function separation and provided further low-pass spatial filtering of the disturbance. From equation~\ref{eq:WidthCutOffRelationship}, this allowed the basis function decomposition to represent spatial frequencies up to approximately $0.12$~Hz. The spatial frequency response of the basis functions can be seen in Figure~\ref{fig:BasisFunctionFreqResponse}.
\begin{figure} 
	\begin{center}

...
\begin{figure}[th]
   	...
   	\end{center}
   	\caption{Example of experimental design and model output.  \textbf{a} Example of data generated by the non-reduced model through a subset of the observations. \textbf{b}. Power spectral density of the data generated by an observation showing the typical $1/f^2$ characteristic of iEEG.} 

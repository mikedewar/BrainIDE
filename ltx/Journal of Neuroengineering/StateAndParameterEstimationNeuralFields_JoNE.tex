...
\end{algorithm}
\section{Results}
We simulated a neural field to the generate data used in the state and parameter estimation. An example of the simulated field can be seen in Figure~\ref{}. The Figure demonstrates the experimental design where the sensors were placed in the centre of the field. 

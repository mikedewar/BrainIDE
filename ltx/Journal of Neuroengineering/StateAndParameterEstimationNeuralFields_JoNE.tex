...
\begin{figure}[th]
   	...
   	\end{center}
   	\caption{\textbf{a.} Example of data generated by the full neural field model. \textbf{b.} Power spectral density of the data generated by an observation showing the typical $1/f^2$ characteristic of iEEG.} 

...
\begin{itemize}
	\item Here we assumed knowledge of the width of the kernel basis functions. If a future work we plan to extend this work to unknown widths. 
	\item The size of the dentritic arbour is consistent in the cortex. This implies global isotropy. Heterogeneity is less consistent. 

...
Applying the \textit{n}-dimensional Fourier transform \cite{Arsac1966} to a \textit{n}-dimensional Gaussian centered at the origin (see equation~\ref{eq:BasisFunctionAtOrigin}) yields
...
In this appendix we provide derivations for the convolution and the inner product of Gaussian basis functions. These derivations are used in the analytic calculation of $\boldsymbol\Psi(\mathbf{r})$. Consider two Gaussian basis functions
\begin{equation}

...
\end{figure}
\begin{figure}[th]
\subfigure[]{\includegraphics[scale=0.55]{./Graph/ZetaConvergence.pdf}}
\subfigure[][]{\includegraphics[scale=0.55]{./Graph/theta0Convergence.pdf}}\\
\subfigure[][]{\includegraphics[scale=0.55]{./Graph/theta1Convergence.pdf}}
\subfigure[][]{\includegraphics[scale=0.55]{./Graph/theta2Convergence.pdf}}

...
% 		propagate the sigma points through the state equation 
		...
		calculate the predicted mean and the predicted covariance matrix
		\begin{equation*}
		...
		compute the filter gain, the update mean and the update covariance matrix using the standard kalman filter formulations
		\begin{equation*}
...
% 		\end{equation*}
		\State compute the predicted mean, the predicted covariance matrix and the cross-covariance matrix
		\begin{equation*}

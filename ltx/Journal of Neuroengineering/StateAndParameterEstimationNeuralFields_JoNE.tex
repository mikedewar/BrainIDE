...
\begin{eqnarray}
	...
	&&\int_\Omega {w\left( \mathbf{r},\mathbf{r}' \right)f\left( {v\left( \mathbf{r}',t \right)} \right)dr'}. \nonumber
\end{eqnarray}
...
Testing if this estimation framework can 
...
In future work, we aim to show how heterogeneous can be modelled within this formulation. We will still assume a isotropic connectivity kernel however heterogenaities can be modelled by placing basis function c

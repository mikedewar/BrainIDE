...
\begin{figure}
   	...
   	\end{center}
   	\caption{An example of continuous field decompposed by a finite number of basis functions scaled by the state vector. } 

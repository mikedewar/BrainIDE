...
\end{figure}
\begin{figure*}[th]
\subfigure[]{\includegraphics[scale=0.5]{./Graph/ZetaConvergence.pdf}}
\subfigure[][]{\includegraphics[scale=0.5]{./Graph/theta0Convergence.pdf}}
\subfigure[][]{\includegraphics[scale=0.5]{./Graph/theta1Convergence.pdf}}
\subfigure[][]{\includegraphics[scale=0.5]{./Graph/theta2Convergence.pdf}}

...
\includegraphics[height=2cm]{UoM_logo.pdf} \\
...
\begin{frame}\frametitle{Observation equation}
	...
	\end{align}
	\pause
	\includegraphics<2-4>[height=3.8cm]{./Figures/SensorKernel1.pdf}
	\includegraphics<3-4>[height=3.8cm]{./Figures/SensorKernel2.pdf}
	\includegraphics<4-4>[height=3.8cm]{./Figures/SensorKernel3.pdf}
	\includegraphics<5->[height=3.8cm]{./Figures/fig13.pdf}
	\includegraphics<6->[height=2cm]{./Figures/WhiteSpace.pdf}
	\includegraphics<6->[height=3.8cm]{./Figures/fig14.pdf}
\end{frame}
